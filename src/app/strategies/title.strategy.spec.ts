...
describe('TitleStrategy', () => {
  ...
  describe('getParam()', () => {
    it('should find top-level params', () => {
      ...
      expect(titleStrategy.getParam('test', route as unknown as RouterStateSnapshot)).toEqual('TEST');
    });
  ...
  describe('formatTitle()', () => {
    it('should find top-level params', () => {
      ...
      expect(titleStrategy.formatTitle(':test - TEST_TITLE', route as unknown as RouterStateSnapshot)).toEqual('TEST · TEST_TITLE');
    });
    it('should find second-level params', () => {
      const route = {
        root: { children: [{ children: [{ children: [], params: { test: 'TEST' } }] }] }
